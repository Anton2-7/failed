...
import {
  ...
  modalClasses,
  useModal
} from "./chunk-PW4I7UMF.js";
import {
  TabPanel,
  getTabPanelUtilityClass,
  tabPanelClasses,
  useTabPanel
} from "./chunk-2J6PVJ7Z.js";
import {
...
function useDropdown(parameters = {}) {
  ...
  const [popupId, setPopupId] = React5.useState("");
  const [triggerElement, setTriggerElement] = React5.useState(null);
  const lastActionType = React5.useRef(null);
  const handleStateChange = React5.useCallback((event, field, value, reason) => {
    if (field === "open") {
      onOpenChange == null || onOpenChange(event, value);
    }
    lastActionType.current = reason;
  }, [onOpenChange]);
  const controlledProps = React5.useMemo(() => openProp !== void 0 ? {
    open: openProp
  } : {}, [openProp]);
...
var TransitionContext = React14.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React15.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React16.useState(true);
  const hasPendingExitTransition = React16.useRef(false);
  const registeredTransitions = React16.useRef(0);
  const [hasTransition, setHasTransition] = React16.useState(false);
  const previousRequestEnter = React16.useRef(requestEnter);
  React16.useEffect(() => {
  ...
  const handleExited = React16.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React16.useCallback(() => {
...
var PopupContext = React17.createContext(null);
if (true) {
...
var Popup = React18.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React18.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React19.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React20.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React21.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
function useMenuItem(params) {
  ...
  const itemMetadata = React22.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React22.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
var InnerMenuItem = React24.memo(React24.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React24.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React26.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React26.useMemo(() => {
    return {
      min,
      max,
      step,
  ...
  const controlledState = React26.useMemo(() => ({
    value: valueProp
  }), [valueProp]);
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React26.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React27.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime16.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime15.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime15.jsx)(IncrementButton, _extends({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime15.jsx)(Input3, _extends({}, inputProps)), endAdornment]
  }));
});
...
var OptionGroup = React28.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
...
var InnerOption = React31.memo(React31.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React31.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
  ...
  return (0, import_jsx_runtime19.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime19.jsx)(InnerOption, _extends({}, props, {
      ref
    }))
  });
});
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime22.jsx)(React35.Fragment, {
...
var TextareaAutosize = React44.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const shadowRef = React44.useRef(null);
  ...
  return (0, import_jsx_runtime34.jsxs)(React44.Fragment, {
...
function CssAnimation(props) {
  ...
  const hasExited = React45.useRef(true);
  React45.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React45.useCallback((event) => {
...
true ? CssAnimation.propTypes = {
  ...
  enterAnimationName: import_prop_types22.default.string,
  enterClassName: import_prop_types22.default.string,
  exitAnimationName: import_prop_types22.default.string,
  exitClassName: import_prop_types22.default.string
} : void 0;
...
var _excluded21 = ["children", "className", "lastTransitionedPropertyOnExit", "enterClassName", "exitClassName"];
var CssTransition = React46.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React46.useState(false);
  React46.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React46.useCallback((event) => {
  ...
  return (0, import_jsx_runtime36.jsx)("div", _extends({
...
true ? CssTransition.propTypes = {
  ...
  enterClassName: import_prop_types23.default.string,
  exitClassName: import_prop_types23.default.string,
  lastTransitionedPropertyOnEnter: import_prop_types23.default.string,
  lastTransitionedPropertyOnExit: import_prop_types23.default.string
} : void 0;
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React47.useRef(false);
  const firstFocus = React47.useRef(true);
  const inputRef = React47.useRef(null);
  const listboxRef = React47.useRef(null);
  const [anchorEl, setAnchorEl] = React47.useState(null);
  const [focusedTag, setFocusedTag] = React47.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React47.useRef(defaultHighlighted);
  ...
  const resetInputValue = React47.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React47.useState(true);
  ...
  const syncHighlightedIndex = React47.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React47.useRef(false);
