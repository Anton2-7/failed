...
import { AccessPage } from "@/pages/accessRights";
import { FaqPage } from "../pages/faq/FaqPage";
import { CreateUpdateQuestion } from "../pages/faq/blocks/faqContent/CreateUpdateQuestion";
import { TasksPage } from "../pages/tasks/TasksPage";
import { CreateUpdateTasks } from "../pages/tasks/blocks/tasksContent/CreateUpdateTasks";
import { StatisticsPage } from "../pages/statistics/StatisticsPage";
import { Giveaways } from "../pages/giveaways/Giveaways";
import { SettingsGiveaway } from "../pages/giveaways/blocks/giveawaySettings/SettingsGiveaway";
import { ListParticipants } from "../pages/giveaways/blocks/listParticipants/ListParticipants";
import { MailingPage } from "../pages/mailing/MailingPage";
import { CreateUpdateMailing } from "../pages/mailing/blocks/MailingContent/CreateUpdateMailing";
import { DocumentationPage } from "../pages/documentation/DocumentationPage";
import { CreateUpdateDocumentation } from "../pages/documentation/blocks/documentationContent/CreateUpdateDocumentation";
      ...
      <Route element={<RequireAuth />}>
        <Route element={<Demo1Layout />}>
          ...
          <Route
            ...
            element={<SettingsGiveaway />}
          />
          <Route
            path="/giveaways/participants/:id?"
            element={<ListParticipants />}
          />
          <Route
            path="/faq/create-update-question/:id?"
            element={<CreateUpdateQuestion />}
          />
          <Route path="/tasks" element={<TasksPage />} />
          <Route
            path="/tasks/create-update-tasks/:id?"
            element={<CreateUpdateTasks />}
          />
          <Route path="/access" element={<AccessPage />} />
          <Route path="/mailing" element={<MailingPage />} />
          <Route
            path="/mailing/create-update-mailing/:id?"
            element={<CreateUpdateMailing />}
          />
          <Route path="/documentation" element={<DocumentationPage />} />
          <Route
            path="/documentation/create-update-documentation/:id?"
            element={<CreateUpdateDocumentation />}
          />
